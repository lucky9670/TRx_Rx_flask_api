...
class services_users():
    ...
    def verify_role_1_data_all(self ): #Driver
    ...
    def verify_role_3_7_data_all(self ): #Driver
    ...
    def verify_role_7_data_all(self):#,dot_number = '', license_number = '' ): #Driver
        err_log = {}
        err_log['permanent_address'] = []
        err_log['f_name'] = []
        err_log['m_name'] = []
    ...
    def get_role_1_data_all(self,id):
        role_1_profile = {
                'services_user':
                {
                    "id": id,
        ...
        return role_1_profile

    def get_role_3_7_data_all(self,id):
        role_2_profile = {
                'services_user':
                {
                    "id": id,
    ...
    def get_role_7_data_all(self,id,org_id):
        role_1_profile = {
                'services_user':
                {
                    "id": id,
    ...
    def update_role_7_data_all(self):
        role_1_profile = {
                'services_user_profile_7':
                {
    ...
    def update_role_3_data_all(self):
        role_1_profile = {
                'services_user_profile_3':
                {

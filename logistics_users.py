...
class log_users():
    ...
    def __init__(self,req):
        self.id = None
        self.org_id = None
        self.f_name = req.get('f_name',"")
        self.m_name = req.get('m_name',"")
        self.l_name = req.get('l_name',"")
        self.role = None
        self.roles = None
        self.status = 0
        self.last_acc = None
        ...
        self.dot_num = req.get('dot_num',"")
        self.license_number = req.get('license_number',"")
        self.state = req.get('state',"")
        self.city = req.get('city',"")
        self.country = req.get('country',"")
        self.email = req.get('email',"")
    ...
    def verify_role_0_data_all(self):
        err_log = {}
        ...
        self.last_acc = self.set_date_current()


        #remove empty spaces from start and end
        self.permanent_address = rep_empty_spaces(str(self.permanent_address))
        self.f_namee = rep_empty_spaces(str(self.f_name))
        self.m_name = rep_empty_spaces(str(self.m_name))
        self.l_name = rep_empty_spaces(str(self.l_name))

        self.state = rep_empty_spaces(str(self.state))
        self.city = rep_empty_spaces(str(self.city))
        self.country = rep_empty_spaces(str(self.country))
        self.email = rep_empty_spaces(str(self.email))

        #verify permanent_address:
        if len(self.permanent_address) == 0 or len(self.permanent_address)  >= 101:
            err_log['permanent_address'].append('Permanent address cannot be empty or more than 100 words')
        
        

        #verify f_name:
        if len(self.f_name) == 0 or len(self.f_name)  >= 65:
            err_log['f_name'].append('First name cannot be empty or more than 64 words')
        
        
        #verify m_name:
        if len(self.m_name) > 65:
            err_log['m_name'].append('Middle name cannot be more than 64 words')
        
        
        #verify l_name:
        if len(self.l_name) == 0 or len(self.l_name) >= 65:
            err_log['l_name'].append('Last name cannot be empty or more than 64 words')
        ...
        #verify email:
        if len(self.email) == 0 or len(self.email)  >= 65:
            err_log['email'].append('Email cannot be empty or more than 64 words')
    ...
    def verify_role_2_6_data_all(self ): #Driver
        err_log = {}
        err_log['permanent_address'] = []
        err_log['f_name'] = []
        err_log['m_name'] = []
        ...
        self.country = rep_empty_spaces(str(self.country))
        self.email = rep_empty_spaces(str(self.email))
        self.license_number = rep_empty_spaces(str(self.license_number))
        self.dot_num = rep_empty_spaces(str(self.dot_num))
        ...
        #verify contact_num
        self.contact_num = str(self.contact_num)
        if not self.contact_num.isdigit():
            err_log['contact_num'].append('Contact number can only be in numbers')
        ...
        #verify dot_num
        if len(self.dot_num) == 0 or len(self.dot_num)  >= 201:
            err_log['dot_num'].append('DOT number cannot be empty or more than 200 words')

        #verify liscence number
        if len(self.license_number) == 0 or len(self.license_number)  >= 201:
            err_log['license_number'].append('License number cannot be empty or more than 200 words')
    ...
    def verify_role_6_data_all(self):#,dot_number = '', license_number = '' ): #Driver
        err_log = {}
        err_log['permanent_address'] = []
        err_log['f_name'] = []
        err_log['m_name'] = []
        ...
        #verify contact_num
        self.contact_num = str(self.contact_num)
        num = self.contact_num[-11:]
        code = self.contact_num[:-11]
        ...
        if len(num) != 11:
            err_log['contact_num'].append('Contact number should be 11 digits without the country code')
    ...
    def verify_employee_rep_data_all(self):#,dot_number = '', license_number = '' ): #Driver
        err_log = {}
        err_log['permanent_address'] = []
        err_log['f_name'] = []
        err_log['m_name'] = []
    ...
    def verify_country(self):#,dot_number = '', license_number = '' ): #Driver
        err_log = {}
    ...
    def verify_states(self):#,dot_number = '', license_number = '' ): #Driver
        err_log = {}
    ...
    def get_role_2_6_data_all(self,id):
        role_2_profile = {
                'logistics_user':
                {
                    "id": id,
                ...
                'logistics_user_profile_2':
                {
                    ...
                    "country":self.country,
                    "email":self.email,
                    "dot_num":self.dot_num,
                    "license_number":self.license_number

                },
                'logistics_user_profile_6':
                {
                    "id":  id,
                    "role":self.role_6,
                    "date_created":self.date_created,
        ...
        return role_2_profile

    def get_role_6_data_all(self,id):
        role_6_profile = {
            'logistics_user':
                {
                    "id":id,
        ...
        return role_6_profile

    def update_role_6_data_all(self):
        role_6_profile = {
            'logistics_user_profile_6':
                {
                    "f_name":self.f_name,
    ...
    def update_role_2_data_all(self):
        role_6_profile = {
            'logistics_user_profile_2':
                {
                    "f_name":self.f_name,

...
class   cognito():
    def __init__(self):
        ...
        self.userpool_id = "us-east-2_wLVcnfYJR"
        self.app_client_id = '5gei7r1kk1dvdn8m23u0bigflj'
        self.keys_url = 'https://cognito-idp.{}.amazonaws.com/{}/.well-known/jwks.json'.format(self.region,self.userpool_id)
        self.url_get_tokens = 'https://trx-help-center.auth.us-east-2.amazoncognito.com/oauth2/token'
